...
class MenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //method will get photos wih successullyUploadea = false
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            cell.menuItemIcon.image = UIImage(named: "cloud_upload")
            cell.menuItemTitle.text = "Uploads"
            cell.menuItemDescription.text = "\(failedPhotosNumber) photo\(failedPhotosNumber > 1 ? "s" : "") uploading"
        case 1:
            cell.menuItemIcon.image = UIImage(named: "settings")
            cell.menuItemTitle.text = "Settings"
            cell.menuItemDescription.text = ""
        case 2:
            cell.menuItemIcon.image = UIImage(named: "exit_to_app")
            cell.menuItemTitle.text = "Sign out"
